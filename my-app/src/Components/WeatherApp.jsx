        ...
        <div className="bg-weatherBg h-screen pt-10 font-maven">
            ...
            <div className="flex w-[300px] rounded-lg mx-auto m-4">
                <input
                    ...
                    className="h-11 w-[260px] outline-none rounded-tl-lg rounded-bl-lg ps-3"
                    value={location}
                    onChange={e => setLocation(e.target.value)}
                    ref={inputRef}
                />
                <button
                    className="flex items-center justify-center border-2 w-12 rounded-ee-lg rounded-tr-lg text-white border-none bg-indigo-700 hover:bg-indigo-500"
                    onClick={() => searchLocation()}
                ><FaSearch /></button>
            </div>

            {data.name && (
                <div className="border-box grid content-center w-[500px] mx-auto p-5 rounded-lg h-auto bg-slate-800 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-30 ">
                    ...
                    <div className="text-center text-white">
                        ...
                        {data.weather && <h3 className="capitalize">{data.weather[0].description}</h3>}
                    </div>

                    <div className="border-box flex flex-row flex-wrap justify-center gap-3 h-auto p-5">
